...
* 注    意：
*********************************************************************************************************/
void InitCirQueue(StructCirQue* pQue, DATA_TYPE* pBuf, short len)
{
  short i;
...
* 注    意：
*********************************************************************************************************/
void ClearCirQueue(StructCirQue* pQue)
{
  pQue->front   = 0; //队头
  pQue->rear    = 0; //队尾
  pQue->elemNum = 0; //当前队列中元素的个数
...
* 注    意：
*********************************************************************************************************/
unsigned char CirQueueEmpty(StructCirQue* pQue)
{
...
* 注    意：
*********************************************************************************************************/
short CirQueueLength(StructCirQue* pQue)
{
  return(pQue->elemNum);
}
...
*           入的元素数量-队列的容量，即EnCirQueue函数对于超出元素采取不理睬的态度。
*********************************************************************************************************/
short EnCirQueue(StructCirQue* pQue, DATA_TYPE* pInput, short len)
{
  short wLen = 0; //待入队的元素有len个，wLen从0增加到len-1
...
*********************************************************************************************************/
short DeCirQueue(StructCirQue* pQue, DATA_TYPE* pOutput, short len)
{
  short rLen = 0;     //期望取出len个元素，最终能取出rLen个元素
